...
import pro.sky.skyprospringcoursetwohomeworkeight.service.DepartmentServiceImpl;
...
public class DepartmentController {
  ...
  private final DepartmentServiceImpl departmenService;

    public DepartmentController(DepartmentServiceImpl departmenService) {
